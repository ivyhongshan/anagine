...
{var csrfToken = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
  ...
  then(function (response) {return console.log(response.data._mapping[type]);})["catch"](
    function (err) {
      console.log(err);
...
//# sourceMappingURL=src_components_ConnectedFilter_index_jsx-src_components_GuppyWrapper_index_jsx-stories_conf_j-9b8fa2.18398977bffff16318c7.hot-update.js.map